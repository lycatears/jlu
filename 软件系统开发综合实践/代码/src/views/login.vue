    ...
    <div class="login-form flex-col-center">
      <Transition name="fade" mode="out-in">
        <LoginForm
          ...
          @on-register="(val) => { formType = 'register'; uname = val }"
          @on-reset-password="(val) => { formType = 'resetPassword'; uname = val }"
        />
        <RegisterForm
          v-else-if="formType === 'register'"
          :uname
          @on-register="(val) => { formType = 'login'; uname = val }"
          @on-login="formType = 'login'"
        />
        <ResetPasswordForm
          v-else-if="formType === 'resetPassword'"
          :uname
          @on-reset-password="(val) => { formType = 'login'; uname = val }"
          @on-login="formType = 'login'"
        />
      </Transition>
    </div>
